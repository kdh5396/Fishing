...
//        }
     //   setImageUrl(headerDesign.getImageUrl(), fadeDuration);
        if(position == 1)
            setImageUrl("http://www.tothemobile.com/wp-content/uploads/2015/01/CyanogenMod-12-Android-Lollipop-772x350.jpg",fadeDuration);
        else
            setImageUrl("http://www.droid-life.com/wp-content/uploads/2014/10/lollipop-wallpapers10.jpg",fadeDuration);
